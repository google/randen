 ...
 */
    ...
    #define PCG_INLINE   __attribute__((always_inline))
#else
    #define PCG_NOINLINE
    #define PCG_INLINE
#endif
...
// google3 crosstool consistently fails to recognize rotr / rotl methods as
// hardware rotations, so force it to use inlined assembly.
// TODO(ahh): switch *everything* to wg21.link/P0553 when that's an option.
